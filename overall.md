...
ゲームソフトの標準的な機能を定義する`ゲームソフトインターフェース(GameSoft.java)'を作成する。

A ボタンと B ボタンを押した際の機能を定義した`文字ボタンインターフェース(CharacterKeyEnable.java)`を作成する。

十字キーを押した際の機能を定義した`十字キーインターフェース(CharacterKeyEnable.java)`を作成する。 今回キーボードの十字キーを使用するのではなく、`k キー`を`↑ キー`に、`j キー`を`↓ キー`に、`l キー`を`→ キー`に、`h キー`を`← キー`として使用する。
...
- メソッド
  ...
  | メソッド名 | 引数 | 戻り値 | 説明                                 |
  | ---------- | ---- | ------ | ------------------------------------ |
  | pushK      | なし | 整数   | k キーが押された時の処理を実装する。 |
  | pushJ      | なし | 整数   | j キーが押された時の処理を実装する。 |
  | pushL      | なし | 整数   | l キーが押された時の処理を実装する。 |
  | pushH      | なし | 整数   | h キーが押された時の処理を実装する。 |

### 問題２

抽象クラスである`ゲームクラス(Game.java)`と`ゲームソフトクラス(Soft.java)`を作成する。`ゲームソフトクラス(Soft.java)`は、`ゲームソフトインターフェース(GameSoft.java)`を実装する。
...
`ゲームソフトインターフェース(GameSoft.java)`を実装する
...
ゲーム機の実体である`岡ステーション(OkaStation.java)`を作成する。`岡ステーション(OkaStation.java)`は`ゲームクラス(Game.java)`を継承する。

ゲームソフトの実体である`岡本の人生(OkaBoardGame.java)`を作成する。`岡本の人生(OkaBoardGame.java)`は`ゲームソフトクラス(Soft.java)`を継承し、`文字ボタンインターフェース(CharacterKeyEnable.java)`を実装する。
...
`ゲームソフトクラス(Soft.java)`を継承し、`文字ボタンインターフェース(CharacterKeyEnable.java)`を実装する。
...
ゲームソフトの実体である`岡本の冒険(OkaAdventure.java)`を作成する。`岡本の冒険(OkaAdventure.java)`は`ゲームソフトクラス(Soft.java)`を継承し、`文字ボタンインターフェース(CharacterKeyEnable.java)`と``十字キーインターフェース(CharacterKeyEnable.java)`を実装する。
...
以下の実行結果となるように、動作確認クラス`Main.java`を作成する。
